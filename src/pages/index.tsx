...
export const getStaticProps: GetStaticProps = async () => {
  ...
  // Utilizando yarn add pakcage 'axios' para poder definir parametros das requisições http
  // _limit: define limite de 12 episodios 
  // _sort: ordena pela data de publicação
  // _order: ordena decrescente.
